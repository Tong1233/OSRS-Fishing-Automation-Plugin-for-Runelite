package net.runelite.client.plugins.BarbFlyFishing.naturalmouse.tools;

import net.runelite.client.plugins.BarbFlyFishing.naturalmouse.api.MouseInfoAccessor;
import net.runelite.client.plugins.BarbFlyFishing.naturalmouse.api.SystemCalls;
import net.runelite.client.plugins.BarbFlyFishing.naturalmouse.support.DefaultMouseInfoAccessor;
import net.runelite.client.plugins.BarbFlyFishing.naturalmouse.support.DefaultSystemCalls;
