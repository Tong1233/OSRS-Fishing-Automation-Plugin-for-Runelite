package net.runelite.client.plugins.BarbFlyFishing.naturalmouse.util;

import net.runelite.client.plugins.BarbFlyFishing.naturalmouse.api.MouseMotionFactory;
import net.runelite.client.plugins.BarbFlyFishing.naturalmouse.api.SpeedManager;
import net.runelite.client.plugins.BarbFlyFishing.naturalmouse.support.DefaultMouseMotionNature;
import net.runelite.client.plugins.BarbFlyFishing.naturalmouse.support.DefaultNoiseProvider;
import net.runelite.client.plugins.BarbFlyFishing.naturalmouse.support.DefaultOvershootManager;
import net.runelite.client.plugins.BarbFlyFishing.naturalmouse.support.DefaultSpeedManager;
import net.runelite.client.plugins.BarbFlyFishing.naturalmouse.support.DoublePoint;
import net.runelite.client.plugins.BarbFlyFishing.naturalmouse.support.Flow;
import net.runelite.client.plugins.BarbFlyFishing.naturalmouse.support.MouseMotionNature;
import net.runelite.client.plugins.BarbFlyFishing.naturalmouse.support.SinusoidalDeviationProvider;
